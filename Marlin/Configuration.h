...
#define STRING_CONFIG_H_AUTHOR "(A10M SKR 1.4 Turbo 04/07/2020)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "A10M SKR1.4 V7"
 ...
 * :[2,3,4,5,6,7]
 */
#define ENDSTOP_NOISE_THRESHOLD 2 // APL Change
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.6, 400, 430 }
...
//#define Z_MIN_PROBE_PIN P0_10 // added for the servo pin power A.Lees
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -41, 0, -0.8 }
...
//#define VALIDATE_HOMING_ENDSTOPS //APL poss re-add
